...
export default function transCore(_a) {
    ...
    var t = function (key, query, options) {
        ...
        var _b = config.nsSeparator, nsSeparator = _b === void 0 ? ':' : _b;
        var _c = splitNsKey(k, nsSeparator), i18nKey = _c.i18nKey, _d = _c.namespace, namespace = _d === void 0 ? (_a = options === null || options === void 0 ? void 0 : options.ns) !== null && _a !== void 0 ? _a : config.defaultNS : _d;
